...
description: "Deploy Nexus as a Cloudflare Worker in under 5 minutes"
---

## Prerequisites

1. Sign up for a [Cloudflare](https://wo2.ww.cloudflare.com/) account.
2. Install [Wrangler](https://developers.cloudflare.com/workers/cli-wrangler/install-update) - the official Cloudflare Workers CLI.
3. Sign up for an [Alchemy](https://www.alchemy.com/), [Ankr](https://www.ankr.com/) or [Infura](https://infura.io/) account. You will need this to connect to the Ethereum network.
