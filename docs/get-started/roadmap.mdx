...
<Steps>
  ...
  <Step title="Web Socket Support">
    Nexus currently has experimental WebSocket support for NodeJS. Cloudflare Workers currently only support http requests. For more information, see the [Websockets](/features/websockets) page.
  </Step>
